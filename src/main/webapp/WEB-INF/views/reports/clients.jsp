						...
						<div class="col-md-12">
							...
							<table class="order-table table">
								...
								<tbody>
									...
									%>
									<tr class="pointer-main" onclick="viewClientsRepFn(<%=clientId%>);">
										<td class="pointer" onclick="viewClientsRepFn(<%=clientId%>);"><c:out
										...
										<c:choose>
											<c:when test="${client.active == false }">
												<td class="pointer" onclick="viewClientsRepFn(<%=clientId%>);"><i
