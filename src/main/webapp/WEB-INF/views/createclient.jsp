				...
				<div class="col-md-12 pull-right whitebg">
					<div class="whitebg">
						<div class="col-md-12">
							...
							<form name="createclientform" novalidate="novalidate"
								...
								<fieldset>
									...
									<div class="form-group">
										<label class="control-label col-sm-2">Client Type</label>

										<div class="col-sm-3">
											<select class="form-control chosen-select" id="clienttypeId"
												tabindex="2">
										...
										<label class="control-label col-sm-2">Client
											Classification</label>

										<div class="col-sm-3">
											<select class="form-control chosen-select"
												id="clientClassificationId" tabindex="2">
												<option value="clientclass1" selected="selected">Classification
													one</option>
												<option value="clientclass2">Classification two</option>
												<option value="clientclass3">Classification three</option>
											</select>
										</div>
									</div>
									<div class="form-group">
