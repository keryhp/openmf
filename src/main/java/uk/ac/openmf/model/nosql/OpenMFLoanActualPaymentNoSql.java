 ...
 *
 */
public class OpenMFLoanActualPaymentNoSql extends OpenMFEntityNoSql  implements OpenMFLoanActualPayment {

	public OpenMFLoanActualPaymentNoSql(Entity entity) {
		super(entity);
	}

	public OpenMFLoanActualPaymentNoSql(Key parentKey, String kind) {
