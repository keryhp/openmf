				...
				<div class="col-md-12 pull-right whitebg">
					...
					<div class="col-md-12">
						<ul class="breadcrumb">
							...
							<li class="active">Make Savings Deposit</li>
						</ul>
						<form:form id="savingsdeposit" class="form-horizontal"
							method="post" modelAttribute="savingsDepositForm">
							<fieldset>
								...
								<div class="form-group">
									<form:label class="control-label col-sm-2" path="amountpaid">Amount Deposit<span
											class="required">*</span>
									</form:label>

									<div class="col-sm-3">
										<form:input type="number" step="any" path="amountpaid"
											class="form-control" required="required" />
									</div>
									<form:label class="control-label col-sm-2" path="dateofpayment">
										<i class="fa fa-calendar fa-1x"></i>Deposit Date<span
											class="required">*</span>
									</form:label>
									<div class="col-sm-2">
