					...
					<div class="row paddedleft paddedtop">
						<div class="col-sm-6 col-md-6">
							<div class="list-group">
								<a class="list-group-item" href="/loanproducts.htm">
									<h4 class="list-group-item-heading">
										<i class="fa fa-tags fa-1x"></i> Loan Products
									</h4>

									<p class="list-group-item-text">Add new or modify or
										deactivate or assign loans</p>
								</a>
																<a class="list-group-item" href="/savingsproducts.htm">
									<h4 class="list-group-item-heading">
										<i class="fa fa-briefcase fa-1x"></i> Savings Products
									</h4>

									<p class="list-group-item-text">Add new or modify or
										deactivate or assign savings</p>
								</a>
																<a class="list-group-item" href="/charges.htm">
									<h4 class="list-group-item-heading">
										<i class="fa fa-puzzle-piece fa-1x"></i> Manage charges
									</h4>

									<p class="list-group-item-text">Add new or modify or
										apply charges on products</p>
								</a>
							</div>
						</div>
					</div>
