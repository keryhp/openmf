...
<title>Savings Products Info</title>
			...
			<div class="row whitebg">
				<div class="col-md-12 pull-right whitebg">
					<div class="whitebg">
						<div class="col-md-12">
							<ul class="breadcrumb">
								<li class="active">Savings Products</li>
							</ul>
						</div>
						<div class="col-md-12">
							<div class="pull-right">
								<a href="/createsavingsproduct.htm" class="btn btn-primary"><i
									class="fa fa-plus fa fa-white"></i>Create Savings Product</a>
							</div>
							<input type="search"
								class="light-table-filter marginbottom0px form-control"
								data-table="order-table" placeholder="Filter by Name/Savings id" />
